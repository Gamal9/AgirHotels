...
namespace AgirHotels.iOS
{
    public class TransitionNavigationPageRenderer : NavigationRenderer
    {
        ...
        {
            if (e.PropertyName == Helper.TransitionNavigationPage.TransitionTypeProperty.PropertyName)
                UpdateTransitionType();
        }

        private void UpdateTransitionType()
        {
            var transitionNavigationPage = (Helper.TransitionNavigationPage)Element;
